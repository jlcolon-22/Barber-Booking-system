...
@section('content')
    ...
    <main
        ...
        <div class="grid grid-cols-1 lg:w-4/5 px-10  mx-auto py-10 bg-black bg-opacity-90">
            <h1 class="pb-10 font-bold text-2xl">User Appointment History</h1>
                    ...
                    <tbody>
                        ...
                        @forelse($appointments as $appointment)
                            <tr class=" border-b bg-gray-900 border-gray-700">
                                ...
                                <td class="px-6 py-4">
                                    <img src="{{ asset($appointment->postInfo->photo) }}" class="h-[4rem] w-[4rem]"
                                        loading="lazy" alt="">
                                </td>
                                <td class="px-6 py-4">
                                ...
                                <td class="px-6 py-4">
                                    @if ($appointment->status == 1)
                                        <span
                                            class=" text-xs font-medium mr-2 px-2.5 py-0.5 rounded bg-green-900 text-green-300">Approved</span>
                                    @elseif ($appointment->status == 0)
                                        <span
                                            class=" text-xs font-medium mr-2 px-2.5 py-0.5 rounded bg-yellow-900 text-yellow-300">Pending</span>
                                    @elseif ($appointment->status == 3)
                                        <span
                                            class=" text-xs font-medium mr-2 px-2.5 py-0.5 rounded bg-violet-900 text-violet-300">Finish</span>
                                    @else
                                        <span
                                            class=" text-xs font-medium mr-2 px-2.5 py-0.5 rounded bg-red-900 text-red-300">Cancelled</span>
                                    @endif
                                </td>
