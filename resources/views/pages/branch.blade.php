...
@section('content')
    ...
    <main class="bg-[url('/assets/bg3.jpeg')]  bg-cover bg-center  min-h-[100svh] origin-bottom items-center z-50 ">
        ...
        <section class=" px-10 py-10">
            ...
            <div class="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0">
                ...
                <div id="profile"
                    ...
                    <div class="p-4 md:p-12 text-center lg:text-left">
                        ...
                        <h1 class="text-3xl text-gray-700 font-bold pt-8 lg:pt-0">{{ $branch->name }}</h1>
                        <div class="mx-auto lg:mx-0 w-4/5 pt-3 border-b-2 border-green-500 opacity-25"></div>
                        <p class="pt-4 text-base font-bold flex items-center justify-center lg:justify-start text-gray-700">
                            <svg class="h-4 fill-current text-green-700 pr-4" xmlns="http://www.w3.org/2000/svg"
                                 viewBox="0 0 20 20">
                                <path
                                    d="M9 12H1v6a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-6h-8v2H9v-2zm0-1H0V5c0-1.1.9-2 2-2h4V2a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v1h4a2 2 0 0 1 2 2v6h-9V9H9v2zm3-8V2H8v1h4z"/>
                            </svg> {{ $owner->firstname . ' ' . $owner->lastname . ' ' }} <span
            ...
            <div class="px-10 py-10 bg-white">
                <h1 class="text-gray-900 text-2xl font-bold">Certificates</h1>
                <div class="flex gap-4 overflow-x-auto max-w-full py-2">
                    @forelse($owner->certificates as $certificate)

                        <div
                            class="min-h-[10rem] max-h-[10rem] cursor-pointer hover:opacity-80 transition-all ease-in-out duration-400"
                            onclick="show(this)">
                            <img
                                class="min-h-[10rem] max-h-[10rem]  max-w-full min-w-[10rem] object-cover origin-top rounded-lg"
    ...
    <div id="feedbackModal" tabindex="-1" aria-hidden="true"
         class="fixed top-0 left-0  right-0 z-50 hidden flex justify-center pt-10 w-full px-4 pb-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
        <div class="relative w-full max-w-2xl max-h-full">
            <!-- Modal content -->
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                <!-- Modal header -->
                    ...
                    @forelse($branch->feedbacks as $feedback)
                        <article class="border-b border-gray-500">
                            <div class="flex items-center mb-4 space-x-4">
                                <img class="w-10 h-10 rounded-full" src="{{asset($feedback->userInfo->profile)}}"
                                     alt="">
...
@section('scripts')
    <script>
        ...
        function toggleMap()
        {
            branchMap.classList.toggle('hidden');
        }
    </script>
@endsection
