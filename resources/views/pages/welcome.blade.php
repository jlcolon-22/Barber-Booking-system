...
@section('content')
 ...
 <x-frontend_header/>
    ...
    <main class="bg-[url('/assets/bg3.jpeg')]  bg-cover bg-center min-h-[100svh] origin-bottom items-center z-50 ">
        ...
        <section class="text-gray-600 body-font bg-black/0">
            <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
                <div
                    class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
                    <h1 class="title-font text-4xl lg:text-6xl mb-4 font-medium text-gray-50 ">Improve your Selfie
                        <br class="hidden lg:inline-block">Go and See Your Barber
                    </h1>
                    <p class="mb-8 leading-relaxed text-gray-100 text-base md:text-2xl"> This online barbershop reservation is for Angeles City to
