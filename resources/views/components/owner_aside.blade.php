<div>
    <button id="navBtn" type="button"
            class="inline-flex items-center p-2 mt-2 ml-3 text-base text-gray-500 rounded-lg sm:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
            ...
            <ul class="space-y-2 font-medium">
                <li>
                    ...
                    <a href="/owner/dashboard"
                       class="flex items-center p-2 rounded-lg text-white  hover:bg-gray-700 group {{ request()->is('owner/dashboard') ?  'bg-gray-700  '  : ''}}">
                        <svg
                            class="w-5 h-5 text-gray-400 transition duration-75  group-hover:text-white  {{ request()->is('owner/dashboard') ?  'text-white  '  : ''}}"
                ...
                <li>
                    <a href="/owner/message"
                       class="flex items-center p-2 rounded-lg text-white  hover:bg-gray-700 group  {{ request()->is('owner/message') ?  'bg-gray-700  '  : ''}}">
                        <svg
                            class="w-5 h-5 text-gray-400 transition duration-75  group-hover:text-white  {{ request()->is('owner/message') ?  'text-white '  : ''}}"
                ...
                <li>
                    <a href="/owner/account"
                       class="flex items-center p-2 rounded-lg text-white  hover:bg-gray-700 group  {{ request()->is('owner/account') ?  'bg-gray-700  '  : ''}}">
                        <svg
                            class="w-5 h-5 text-gray-400 transition duration-75  group-hover:text-white  {{ request()->is('owner/account') ?  'text-white '  : ''}}"
                            viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="currentColor">
                        ...
                        <span class="ml-3">Employee Account</span>
                    </a>
                </li>
                <li>
                    <a href="/owner/certificate"
                       class="flex items-center p-2 rounded-lg text-white  hover:bg-gray-700 group  {{ request()->is('owner/certificate') ?  'bg-gray-700  '  : ''}}">
                        <svg
                            class="w-5 h-5 text-gray-400 transition duration-75  group-hover:text-white  {{ request()->is('owner/certificate') ?  'text-white '  : ''}}"
                            viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="currentColor">
                ...
                <li>
                    <a href="/owner/appointment"
                       class="flex items-center p-2 rounded-lg text-white  hover:bg-gray-700 group  {{ request()->is('owner/appointment') ?  'bg-gray-700  '  : ''}}">
                        <svg
                            class="w-5 h-5 text-gray-400 transition duration-75  group-hover:text-white  {{ request()->is('owner/appointment') ?  'text-white '  : ''}}"
                            viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="currentColor">
                ...
                {{--         <li>
                           <a href="/owner/posts" class="flex items-center p-2 rounded-lg text-white  hover:bg-gray-700 group  {{ request()->is('owner/posts') ?  'bg-gray-700  '  : ''}}">
                               <svg class="w-5 h-5 text-gray-400 transition duration-75  group-hover:text-white  {{ request()->is('owner/posts') ?  'text-white '  : ''}}"  viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="currentColor">
                ...
                <li>
                    <a href="/auth/logout" class="flex items-center p-2 rounded-lg text-white  hover:bg-gray-700 group">
                        <svg class="w-5 h-5 text-gray-400 transition duration-75  group-hover:text-white"
                             fill="currentColor" width="256px" height="256px" viewBox="0 0 28 24" version="1.1"
                             xmlns="http://www.w3.org/2000/svg">
                            ...
                            <g id="SVGRepo_iconCarrier"><title>logout</title>
                                <path
