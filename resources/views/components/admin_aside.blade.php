<div>
    <button id="navBtn" type="button" class="inline-flex items-center p-2 mt-2 ml-3 text-base text-gray-500 rounded-lg sm:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
    ...
    <aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
        <div class="h-full px-3 py-4 overflow-y-auto bg-gray-800">
           ...
           <ul class="space-y-2 font-medium">
              ...
              <li>
                <a href="/admin/message" class="flex items-center p-2 rounded-lg text-white  hover:bg-gray-700 group  {{ request()->is('admin/account') ?  'bg-gray-700  '  : ''}}">
             ...
             <li>
              ...
              <li>
                <a href="/admin/reports" class="flex items-center p-2 rounded-lg text-white  hover:bg-gray-700 group  {{ request()->is('admin/reports') ?  'bg-gray-700  '  : ''}}">
                    <svg class="w-5 h-5 text-gray-400 transition duration-75  group-hover:text-white  {{ request()->is('admin/reports') ?  'text-white '  : ''}}"  viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="currentColor">
