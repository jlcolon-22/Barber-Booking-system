    ...
    <aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
        <div class="h-full px-3 py-4 overflow-y-auto bg-gray-800">
           ...
           <ul class="space-y-2 font-medium">
                ...
                <li>
                <a href="/employee/appointment" class="flex items-center p-2 rounded-lg text-white  hover:bg-gray-700 group  {{ request()->is('employee/appointment') ?  'bg-gray-700  '  : ''}}">
                    <svg class="w-5 h-5 text-gray-400 transition duration-75  group-hover:text-white  {{ request()->is('employee/appointment') ?  'text-white '  : ''}}"  viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="currentColor">
