                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span class="ml-1 text-base font-medium  md:ml-2 text-gray-100">Branch</span>
                        </div>
                    </li>
                            ...
                            @forelse ($branches as $branch)
                                <tr class=" border-b bg-gray-900 border-gray-700">
                                    ...
                                    <td class="px-6 py-4">
                                        ...
                                        <a href="/admin/branch/delete/{{$branch->id}}" class="font-medium text-red-500 hover:underline">Delete</a>
                                    </td>
                                </tr>
                            @empty
                            @endforelse
