  ...
  <h1 class="pb-10 font-bold">Book Information</h1>
     <!--    @if(session()->has('success'))
      ...
      <div class="pb-10 flex flex-col  md:flex-row w-fit gap-3">
        <img :src="information?.photo" class="max-h-[10rem] min-w-[15rem] object-top object-cover rounded" loading="lazy" alt="">
        <div>
          ...
          <br>
          Branch Location: <span class="opacity-75"> {{information?.branch?.location}}</span>
        </div>
      </div>
